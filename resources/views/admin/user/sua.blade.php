        ...
        <div class="row">
            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                <form action="admin/user/sua/{{$user->id}}" method="POST">
                    ...
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" name="email" placeholder="Nhập địa chỉ emial" value="{{$user->email}}" readonly="" />
                    </div>
                    <div class="form-group">
                        <input type="checkbox" id="changePassword" name="changePassword">
                        <label>Đổi mật khẩu</label>
                        <input class="form-control password" name="password" placeholder="Nhập mật khẩu" type="password" disabled="" />
                    </div>
                    <div class="form-group">
